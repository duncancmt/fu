...
library Settings {
    ...
    uint256 internal constant ANTI_WHALE_DIVISOR = 16;
    ...
    // 178 million. This is smaller than the ratio between the initial shares ratio and the minimum
    // shares ratio, approximately 215 million.
